...
#define NVMEF_REQUEST_IN_STATE_SUBMITTING (NVMEOF_WORK_REQUEST_STATE_ALLOCATED | NVMEOF_WORK_REQUEST_STATE_INITIALIZED | NVMEOF_WORK_REQUEST_STATE_PREPARE_SUBMITTING |  \
	                                          NVMEOF_WORK_REQUEST_STATE_SUBMITTING)

#define NVMEF_REQUEST_ALL_STATE_DONE (NVMEOF_WORK_REQUEST_STATE_ALLOCATED | NVMEOF_WORK_REQUEST_STATE_INITIALIZED | NVMEOF_WORK_REQUEST_STATE_PREPARE_SUBMITTING |  \
...
typedef struct DECLSPEC_CACHEALIGN _NVMEF_TRANSPORT_RDMA_BUFFER_MDL {
	PNVMEOF_RDMA_SGL_LAM_MAPPING psLamSglMap;
	PVOID                        pvBuffer;
	PMDL                         psBufferMdl;
	ULONG                        ulBufferLength;
	ULONG                        ulBufferFlag;
} NVMEF_TRANSPORT_RDMA_BUFFER_MDL, *PNVMEF_TRANSPORT_RDMA_BUFFER_MDL;
...
typedef struct DECLSPEC_CACHEALIGN _NVMEOF_RDMA_WORK_REQUEST {
	...
	WORK_REQUEST_COMPLETION_OPS          sWorkReqCompletionOps;
	PVOID                                pvParentReqCtx;
	PNVMEF_TRANSPORT_RDMA_BUFFER_MDL     psDataBufferMdlMap;
	PNVMEF_TRANSPORT_RDMA_BUFFER_MDL     psBufferMdlMap;
